<%-- 
    Document   : form_reporte_ganancias
    Created on : 11 mar 2025, 0:04:19
    Author     : rafael-cayax
--%>
    ...
    <body>
        ...
        <div class="d-flex justify-content-center">
            <div class="card w-50 m-3 border-info">
                <div class="card-body">
                    <h5 class="card-title
                        text-center">Reporte de ganancias</h5>
                    <form class="mb-5" action="${pageContext.servletContext.contextPath}/controllers/financiero/reporte_ganancias" method="post">
