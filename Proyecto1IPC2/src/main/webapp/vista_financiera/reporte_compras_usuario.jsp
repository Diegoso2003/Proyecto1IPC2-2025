...
<html>
    ...
    <body>
        ...
        <c:if test="${reporte.usuario == null}">
        ...
        <c:if test="${reporte.usuario != null}">
            ...
            <div class="d-flex justify-content-center m-3">
                <div class="card w-50 m-3 border-info">
                    <div class="card-body">
                        <h5 class="card-title text-center">Vendedor: ${reporte.usuario.nombre}</h5>
                        <p class="card-text"><strong>Total de ventas:</strong> ${reporte.totalVentas}</p>
