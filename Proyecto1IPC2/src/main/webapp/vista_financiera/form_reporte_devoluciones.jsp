<%-- 
    Document   : form_reporte_devoluciones
    Created on : 10 mar 2025, 12:39:57
    Author     : rafael-cayax
--%>
    ...
    <body>
        ...
        <div class="d-flex justify-content-center">
            <div class="card w-50 m-3 border-info">
                <div class="card-body">
                    <h5 class="card-title
                        text-center">Reporte de Devoluciones</h5>
                    <form class="mb-5" action="${pageContext.servletContext.contextPath}/controllers/financiero/reporte_devolucion" method="post">
