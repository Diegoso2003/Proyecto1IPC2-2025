<%-- 
    Document   : form_reporte_compras_usuario
    Created on : 10 mar 2025, 18:46:10
    Author     : rafael-cayax
--%>
    ...
    <body>
        ...
        <div class="d-flex justify-content-center">
            <div class="card w-50 m-3 border-info">
                <div class="card-body">
                    <h5 class="card-title
                        text-center">Reporte de Usuario con mas ventas</h5>
                    <form class="mb-5" action="${pageContext.servletContext.contextPath}/controllers/financiero/reporte_compras_usuario" method="post">
