<%-- 
    Document   : form_computadora_menos_vendida
    Created on : 11 mar 2025, 16:29:33
    Author     : rafael-cayax
--%>
    ...
    <body>
        ...
        <div class="d-flex justify-content-center">
            <div class="card w-50 m-3 border-info">
                <div class="card-body">
                    <h5 class="card-title
                        text-center">Reporte de computadora con menos ventas</h5>
                    <form class="mb-5" action="${pageContext.servletContext.contextPath}/controllers/financiero/compu_menos_ventas" method="post">
