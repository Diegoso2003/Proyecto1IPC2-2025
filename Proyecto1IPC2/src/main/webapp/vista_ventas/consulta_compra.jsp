<%-- 
    Document   : consulta_compra
    Created on : 9 mar 2025, 14:44:39
    Author     : rafael-cayax
--%>
    ...
    <body>
        ...
        <div class="d-flex justify-content-center">
            <div class="card w-50 m-3 border-info">
                <div class="card-body">
                    <h5 class="card-title
                        text-center">Consulta de Compra</h5>
                    <form class="mb-5" action="${pageContext.servletContext.contextPath}/controllers/ventas/consulta_compra" method="post">
