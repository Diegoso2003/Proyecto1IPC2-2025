 ...
 * @author rafael-cayax
 */
@WebServlet(name = "ServletReporteComprasUsuario", urlPatterns = {"/controllers/financiero/reporte_compras_usuario"})
public class ServletReporteComprasUsuario extends HttpServlet {
